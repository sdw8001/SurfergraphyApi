namespace SurfergraphyApi.Migrations
{
    ...
    public partial class surfergraphy : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PhotograperId = c.Int(nullable: false),
                        Name = c.String(),
                        Url = c.String(),
                        Place = c.String(),
                        Wave = c.Int(nullable: false),
                        MimeType = c.String(),
                        DimentionWidth = c.Int(nullable: false),
                        DimentionHeight = c.Int(nullable: false),
